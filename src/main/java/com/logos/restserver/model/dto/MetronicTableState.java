 ...
 * @author rafael
 */
public class MetronicTableState implements Serializable {

    private List<MetronicFilter> filter;
    private MetronicPaginatorState paginator;
    private MetronicSorteState sorting;
    private String searchTerm;
    private MetronicGroupingState grouping;
    private Object entityId;

    public MetronicTableState() {
    }

    public List<MetronicFilter> getFilter() {
        return filter;
    }

    public void setFilter(List<MetronicFilter> filter) {
        this.filter = filter;
    }

    public MetronicPaginatorState getPaginator() {
        return paginator;
    }

    public void setPaginator(MetronicPaginatorState paginator) {
        this.paginator = paginator;
    }

    public MetronicSorteState getSorting() {
        return sorting;
    }

    public void setSorting(MetronicSorteState sorting) {
    ...
    public MetronicGroupingState getGrouping() {
        return grouping;
    }

    public void setGrouping(MetronicGroupingState grouping) {
    ...
    public static String getJsonFromEntity(MetronicTableState entity) {
        return getGson().toJson(entity, getEntityType());
    }

    public static MetronicTableState getEntityFromJson(String json) {
        return (MetronicTableState) getGson().fromJson(json, getEntityType());
    }

    public static List<MetronicTableState> getListFromJson(String json) {
        return getGson().fromJson(json, getEntityTypeList());
    }

    public static String getStringFromList(List<MetronicTableState> list) {
        return getGson().toJson(list, getEntityTypeList());
    }

    public static Type getEntityType() {
        return MetronicTableState.class;
    }
